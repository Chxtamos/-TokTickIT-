...
| API-21 | API/PostgreSQL | AC-15 | Claim self, already-self no-op, other owner409, eligible assign/reassign/unassign with provenance; invalid/inactive target400, terminal staff mutation409 | server/tests/lab-03/staff-ticket-detail.api.test.ts | Planned / Not run |

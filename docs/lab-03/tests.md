...
| E2E-03 | E2E | AC-12, AC-13, AC-14, AC-15, AC-16, AC-17, AC-20, AC-21 | Real queue -> claim/reassign/priority/status/public/private/file download; Requester cannot read private note | client/e2e/lab-03/staff-ticket-flow.spec.ts | Full E2E-03 remains Planned / Not run. #60 supplies API behavior only; #61 conversation APIs are implemented and hosted-tested; #75 integrated Staff UI/browser flow remains pending. The existing Queue-only browser spec is not claimed as E2E-03. |
